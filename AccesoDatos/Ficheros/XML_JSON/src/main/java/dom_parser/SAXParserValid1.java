...
class GestorEventos1 extends DefaultHandler {
    ...
    public GestorEventos1(PrintStream ps) {
        this.ps = ps;
    }
...
public class SAXParserValid1 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            xmlReader.setContentHandler(gestorEventos1);
            xmlReader.setErrorHandler(gestorEventos1);
